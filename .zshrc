...
# Alias most common directories
alias src="cd ~/src"
alias proj="cd ~/src/projects"
alias betheld="cd ~/src/projects/bethel"
alias tmd="cd ~/src/projects/twoMatches/"

# if [ -f /usr/local/etc/bash_completion.d/bethelCopilot_completion.sh ]; then
#    source /usr/local/etc/bash_completion.d/bethelCopilot_completion.sh
# fi
