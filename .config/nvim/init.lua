...
require('lazy').setup({
  ...
  require 'endalk200.plugins.autopairs', -- Autopairs, integrates with Blink.cmp
  ...
  require 'endalk200.plugins.gitsigns', -- adds gitsigns recommend keymaps
